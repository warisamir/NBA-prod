  ...
  useEffect(() => {
    const getStores = async () => {
      ...
      try {
        ...
        // const response2 = await axios.get(`https://gcpprod.testexperience.site/fetch_quiztaken_rsa?territory_id=${query.get("territory_id")}&contest_id=2`);
